...
/*   Updated: 2021/06/11 12:52:14 by mlachheb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * r_a_b : shift up elements of stack (a or b) by 1.
 * the first elements become the last one.
 * r_r : shift up elements of stack (a and b) by 1.
 * the first elements become the last one.
 * r_r_a_b : shift down elements of stack (a or b) by 1.
 * the last elements become the first one.
 * r_r_r : shift down elements of stack (a and b) by 1.
 * the last elements become the first one.
 */
